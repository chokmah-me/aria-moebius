...
Bilar, D. Y. (2026). *Mobius Bridges for the Invert-and-Affine S-box Class, with the Four ARIA Instantiations*. Zenodo. https://doi.org/10.5281/zenodo.21705469

## Contents (on Zenodo)

- `ARIA-Moebius-v1-REL.pdf` / `.md` — paper
- Linked GitHub repository for Lean formalization and `verify_bridge_class.py`
